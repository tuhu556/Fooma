...
Widget profileOthersHeaderWidget(BuildContext context, int index,
    UserProfileResponse userProfile, bool onPress) {
  return Container(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                postReact(userProfile.totalPost.toString(), "Post"),
                const SizedBox(
                  width: 50,
                ),
                postReact(userProfile.totalRecipe.toString(), "Recipe"),
                // postReact("36", "React"),
              ],
            ),
          ),
