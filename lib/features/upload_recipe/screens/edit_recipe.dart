...
class EditRecipeScreen extends StatefulWidget {
  ...
  const EditRecipeScreen(
      {Key? key, this.recipe, this.index, this.onTap, this.pop})
      : super(key: key);
...
class UploadRecipeView extends StatefulWidget {
  ...
  const UploadRecipeView(
      {Key? key, required this.recipe, this.index, this.onTap, this.pop})
      : super(key: key);
          ...
          listener: (context, state) async {
            if (state.status == EditMyRecipeStatus.Processing) {
              ...
              Helpers.shared.showDialogSuccess(context,
                  message: "Sửa đổi công thức thành công",
