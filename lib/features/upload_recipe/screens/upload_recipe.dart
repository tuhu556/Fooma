...
class _UploadRecipeScreenState extends State<UploadRecipeScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: const UploadRecipeView(),
    );
  }
}

class UploadRecipeView extends StatefulWidget {
  const UploadRecipeView({Key? key}) : super(key: key);
...
class _UploadRecipeViewState extends State<UploadRecipeView> {
  ...
  List<TextEditingController> _nameOfIngredientController = [];
          ...
          listener: (context, state) {
            if (state.status == OptionRecipeStatus.Processing) {
              ...
              for (var i in state.recipeMeal!.recipeMeal) {
                // if (i.recipeCategoryName == "Ăn sáng") {
                //   setState(() {
                //     nameOfMeal = i.recipeCategoryName;
                //   });
                // }
                setState(() {
              ...
              for (var i in state.recipeProcess!.recipeProcess) {
                if (i.cookingMethodName == "Chiên") {
                  setState(() {
                    nameOfProcess = i.cookingMethodName;
                  });
                }
                setState(() {
              ...
              setState(() {
                listIngredientDB = state.ingredient!.listIngredient;
              });
            }
          },
        ),
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: SizedBox.fromSize(
                                      size: const Size.fromRadius(
                                          150), // Image radius
                                      child: LoadingImage(urlImg: urlImg),
                                    ),
                                  ),
                                  onTap: () {
