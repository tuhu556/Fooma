...
class FavoriteRecipeDetailScreen extends StatefulWidget {
  final Recipe? recipe;
  final int? index;
  final Function(int)? onTap;
  const FavoriteRecipeDetailScreen({
    Key? key,
    this.recipe,
    this.index,
    this.onTap,
  ...
  @override
  _FavoriteRecipeDetailScreenState createState() =>
      _FavoriteRecipeDetailScreenState();
}

class _FavoriteRecipeDetailScreenState
    extends State<FavoriteRecipeDetailScreen> {
  @override
...
class FavoriteRecipeView extends StatefulWidget {
  ...
  final int? index;
  final Function(int)? onTap;
  const FavoriteRecipeView({Key? key, this.recipe, this.index, this.onTap})
      : super(key: key);
...
class _FavoriteRecipeViewState extends State<FavoriteRecipeView> {
  ...
  @override
  void initState() {
    var parsedDate = DateTime.parse(widget.recipe!.createDate);
  ...
  Widget ingredientField(String weight, String name) {
    return Padding(
